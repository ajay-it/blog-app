    ...
    <Footer container className="border border-t-8 border-teal-500 mt-5">
      <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            <div>
              ...
              <Footer.LinkGroup col>
                ...
                <Footer.Link href="/about">Ajay&apos;s Blog</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
              ...
              <Footer.LinkGroup col>
                ...
                <Footer.Link
                  href="https://www.linkedin.com/in/ajay-it"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  LinkedIn
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
          ...
          />
          <div className="flex gap-6 mt-4 sm:mt-0 sm-max:mt-4 sm:justify-center">
            <Footer.Icon
